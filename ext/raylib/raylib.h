...
RLAPI bool IsSameColor(Color colorA, Color colorB); 					// Compare colors, return true if the same
...
RLAPI bool CheckCollisionPointBox(Vector3 point, BoundingBox box); 										// Check if point is inside/colliding with bounding box
