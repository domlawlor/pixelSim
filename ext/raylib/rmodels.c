...
{
	bool collision = true;
	collision = collision && (point.x >= box.min.x && point.x <= box.max.x);
	collision = collision && (point.y >= box.min.y && point.y <= box.max.y);
	collision = collision && (point.z >= box.min.z && point.z <= box.max.z);
	return collision;
}
